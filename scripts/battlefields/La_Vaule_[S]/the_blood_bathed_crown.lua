...
content.loot =
{
    ...
    },
    {
        ...
        { item = xi.item.APOGEE_PETASOS,    weight = 40 },
        { item = xi.item.APOGEE_COAT,       weight = 40 },
        { item = xi.item.APOGEE_CUFFS,      weight = 40 },
        { item = xi.item.APOGEE_TONBAN,     weight = 40 },
        { item = xi.item.APOGEE_SABOTS,     weight = 40 },
    ...
    -- original drops
    {
        { item = xi.item.SUPREMACY_EARRING,    weight = 500 },
        { item = xi.item.GNADBHODS_HELM,       weight = 500 },
    },
    {
        { item = 15831,            weight = 333 }, -- fenian ring
        { item = 16356,            weight = 333 }, -- nimue's tights
        { item = 17758,            weight = 334 }, -- ruler
    },
}
