...
content.loot =
{
    ...
    },
    {
        ...
        { itemId = xi.item.PINNACLE_CELATA,   weight = 40 },
        { itemId = xi.item.PINNACLE_CUIRASS,  weight = 40 },
        { itemId = xi.item.PINNACLE_DASTANAS, weight = 40 },
        { itemId = xi.item.PINNACLE_CUISSES,  weight = 40 },
        { itemId = xi.item.PINNACLE_SABATONS, weight = 40 },
    ...
    {
        { itemId = xi.item.PINNACLE_CELATA,   weight = 200 },
        { itemId = xi.item.PINNACLE_CUIRASS,  weight = 200 },
        { itemId = xi.item.PINNACLE_DASTANAS, weight = 200 },
        { itemId = xi.item.PINNACLE_CUISSES,  weight = 200 },
        { itemId = xi.item.PINNACLE_SABATONS, weight = 200 },
    },
    {
        { itemId = xi.item.PINNACLE_CELATA,   weight = 80 },
        { itemId = xi.item.PINNACLE_CUIRASS,  weight = 80 },
        { itemId = xi.item.PINNACLE_DASTANAS, weight = 80 },
        { itemId = xi.item.PINNACLE_CUISSES,  weight = 80 },
        { itemId = xi.item.PINNACLE_SABATONS, weight = 80 },
    ...
    -- original drops
    {
        { itemId = xi.item.PARAMOUNT_EARRING,    weight = 500 },
        { itemId = xi.item.ZHAGOS_BARBUT,        weight = 500 },
    },
    {
        { itemId = 15832,            weight = 333 }, -- headsmans ring
        { itemId = 15034,            weight = 333 }, -- stone mufflers
        { itemId = 18501,            weight = 334 }, -- seismic axe
    },
}
